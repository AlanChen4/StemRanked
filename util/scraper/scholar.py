...
def get_scholar_authors(email_domain, field, proxy_path, starting_author=None,
                        limit=1000000, proxy_thread=10, strict=False):
    """
    Return list of authors found on google scholar
    ...
    try:
        ...
        try:
            ...
            if len(base_check) > 0:
                ...
                return get_scholar_authors(email_domain, field, proxy_path,
