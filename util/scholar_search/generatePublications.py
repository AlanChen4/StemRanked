...
def getPubUrls(query): 
    ...
    while (not stop_trigger):
        ...
        time.sleep(random.uniform(1,9))#hopefully enough not to get banned
    return pubs
...
def getAllInfo(auth_profile): 
    ...
    for pub in pubs:
        ...
        time.sleep(random.uniform(0,4))#hopefully enough not to get banned
    return pub_info
...
if __name__ == "__main__":
    main("publication_information.csv","Flora Meilleur",'https://scholar.google.com/citations?user=i0aLPhYAAAAJ&hl=en&oi=sra')
