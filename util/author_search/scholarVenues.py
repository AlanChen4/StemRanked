...
venue_dictionary = {
    'Computer Science': { 
        ...
        'Machine Learning, Data Mining, & Artificial Intelligence': {'NeurIPS': 'Neural Information Processing Systems', 'ICML':'International Conference on Machine Learning', 'AAAI': 'National Conference on Artificial Intelligence'},
